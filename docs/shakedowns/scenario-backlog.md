...
| T14 | Live first-run pair | Live-fire (writes enabled, gated): sprint-planning-facilitator record mode at the AP Blue S89→S90 boundary (~2026-07-17) creates the org's first commitment record; daily-standup-digest runs daily for one sprint with the declared Jira-only banner — turns T4-S2/S8 into tested behavior | Live | AP Blue S90 | queued (time-sensitive: boundary ~Jul 17) | — |
