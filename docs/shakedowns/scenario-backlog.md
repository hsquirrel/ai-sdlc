...
| T2 | Product-driven, in-flight | Even on home turf (product work, rich AC), adoption gaps and content drift appear; house-AC quality tests the DoR critic and test-plan generator for real | Live read-only | KDP-40761 (Client Name Change) + children | **actioned** (2026-07-12: all seven landed — S1 duplication scan, S2 slice floor, S3 house-brief convention, S4 dependency reification, S5 epic NFR source, S6 overlap consolidation, S7 charter paper mode) | [2026-07-11-t2-product-inflight.md](2026-07-11-t2-product-inflight.md) |
...
| T4 | SM ceremony sweep | The 8 SM skills' data needs (velocity, commitment record, flags, activity signals) are unavailable or dirty in the real instance | Live read-only | AP Blue's active sprint + board | **actioned** (2026-07-12: all landed — S1 velocity gate, S2 commitment-baseline reference, S3+S7+S8 consolidated into the team operating record, S4 flag-as-claim, S5 first-run posture, S6 hygiene scale mode + rank/dead-team/zombie-sprint checks) | [2026-07-11-t4-sm-ceremony-sweep.md](2026-07-11-t4-sm-ceremony-sweep.md) |
| T14 | Live first-run pair | Live-fire (writes enabled, gated): sprint-planning-facilitator record mode at the AP Blue S89→S90 boundary (~2026-07-17) creates the org's first commitment record; sprint-radar daily mode runs for one sprint with the declared Jira-only banner (standing approval per the 2026-07-12 gate tiers) — turns T4-S2/S8 into tested behavior | Live | AP Blue S90 | queued (time-sensitive: boundary ~Jul 17) | — |
| T5 | Incident/hotfix + UAT flows | The pipeline has no incident entrance; hotfix and UAT issue types bypass DoR/test skills entirely | Live read-only + synthetic | Real Hotfix/UAT-type usage in KDP + synthetic mid-sprint incident | **actioned** (2026-07-12: S1 incident-hotfix-runner built; S3 hotfix/regression modes, S2 bug-types rewrite, S4 release-notes hotfix mode, S5 incident signals, S8 hygiene checks landed. S7 link-type registry + test-case campaign structure landed 2026-07-12 on follow-up; S6 UAT mode **declined** — not needed now) | [2026-07-11-t5-hotfix-uat.md](2026-07-11-t5-hotfix-uat.md) |
...
| T12 | Governance-artifact tracker | Nothing tracks governance artifacts (ARB reviews, design docs) to completion — T3's perma-"Proposed/Pending" ARB shipped anyway; candidate new skill or SM-skill extension | Partially addressed 2026-07-12: backlog-hygiene-auditor gained a per-initiative dependency/governance rollup; a standalone tracker awaits a demand signal |
