...
| T3 | Historical replay | Pipeline artifacts would have prevented specific observed failures in a completed effort — find which, and which not | Replay | Bulk Upload 2.0 family (KDP-38143 initiative and descendants) | **report-ready** | [2026-07-11-t3-bulkupload-replay.md](2026-07-11-t3-bulkupload-replay.md) |
...
| T9 | Cancelled/pivoted epic | No skill handles scope death: what should happen to briefs, children, catalog links when an epic is killed mid-flight | — |
