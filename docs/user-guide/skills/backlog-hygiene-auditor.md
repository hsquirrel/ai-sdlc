...
1. The sweep flags: **stale** (no edits/comments/rank changes), **likely duplicates** (presented as pairs for human judgment — it doesn't prejudge the survivor), **unestimated near-term**, **orphans** (no parent, no stated reason), **aging `dor-needs-work`**, and **zombie epics** (children all done or all stale).
